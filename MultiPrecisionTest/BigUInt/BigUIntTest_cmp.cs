    ...
    public partial class BigUIntTest {
        ...
        public void CmpTest() {
            ...
            for (int i = 0; i <= 2500; i++) {
                ...
                BigUInt<Pow2.N4, Pow2.N1> n1 = new BigUInt<Pow2.N4, Pow2.N1>(mantissa1);
                BigUInt<Pow2.N4, Pow2.N1> n2 = random.Next(8) < 7 ? new BigUInt<Pow2.N4, Pow2.N1>(mantissa2) : n1.Copy();
