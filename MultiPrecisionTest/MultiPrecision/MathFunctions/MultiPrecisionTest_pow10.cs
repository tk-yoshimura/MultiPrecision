    ...
    public partial class MultiPrecisionTest {
        ...
        public void Pow10Test() {
            ...
            for(int i = 0; i < 32; i++) { 
                ...
                Console.WriteLine((double)y);
                Assert.AreEqual(Math.Pow(10, (double)p), (double)y, Math.Pow(10, (double)p) * 1e-5);
            ...
            for(int i = 0; i < 32; i++) { 
                ...
                Console.WriteLine((double)y);
                Assert.AreEqual(Math.Pow(10, (double)n), (double)y, Math.Pow(10, (double)n) * 1e-5);
            ...
            for(int i = 0; i < 32; i++) { 
                ...
                Console.WriteLine((double)y);
                Assert.AreEqual(Math.Pow(10, (double)p2), (double)y, Math.Pow(10, (double)p2) * 1e-5);
            ...
            for(int i = 0; i < 32; i++) { 
                ...
                Console.WriteLine((double)y);
                Assert.AreEqual(Math.Pow(10, (double)n2), (double)y, Math.Pow(10, (double)n2) * 1e-5);
