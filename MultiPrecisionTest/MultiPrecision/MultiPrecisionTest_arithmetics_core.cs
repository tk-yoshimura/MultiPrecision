...
namespace MultiPrecisionTest {
    ...
    public partial class MultiPrecisionTest {
        ...
        public void AccumulatorAddTest() {
            ...
            for(int f2_exponent = -10; f2_exponent <= 10; f2_exponent++) { 
        ...
        public void AccumulatorDivTest() {
            ...
            for(int b_exponent = -10; b_exponent <= 10; b_exponent++) { 
                for(int a_exponent = -10; a_exponent <= 10; a_exponent++) { 
                    (Mantissa<Pow2.N4> c, Int64 c_exponent, _) = MultiPrecision<Pow2.N4>.Div((a, a_exponent), (b, b_exponent));
            ...
            for(int a_exponent = -10; a_exponent <= 10; a_exponent++) { 
                (Mantissa<Pow2.N4> c, Int64 c_exponent, _) = MultiPrecision<Pow2.N4>.Div((a, a_exponent), (a, a_exponent));
            ...
            for(int a2_exponent = -10; a2_exponent <= 10; a2_exponent++) { 
                for(int a_exponent = -10; a_exponent <= 10; a_exponent++) { 
                    (Mantissa<Pow2.N4> c, Int64 c_exponent, _) = MultiPrecision<Pow2.N4>.Div((a, a_exponent), (a, a2_exponent));
            ...
            for(int f2_exponent = -10; f2_exponent <= 10; f2_exponent++) { 
                for(int f_exponent = -10; f_exponent <= 10; f_exponent++) { 
                    (Mantissa<Pow2.N4> c, Int64 c_exponent, _) = MultiPrecision<Pow2.N4>.Div((Mantissa<Pow2.N4>.Full, f_exponent), (Mantissa<Pow2.N4>.Full, f2_exponent));
